...
export default function AppointmentCTA() {
  ...
  return (
    <section className="py-12 px-6 md:px-12 max-w-[1440px] mx-auto">
      <div className="relative rounded-[32px] overflow-hidden bg-gradient-to-r from-primary to-[#0f766e] text-white py-16 px-8 md:p-20 shadow-xl shadow-primary/10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-8 flex flex-col items-start text-left">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 border border-white/10 mb-6">
              <Smile className="w-4 h-4 text-accent animate-pulse" />
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto">
              <a
                ...
                className="px-8 py-4 bg-accent hover:bg-teal-400 text-dark-text text-base font-bold rounded-full shadow-lg hover:shadow-accent/20 transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center gap-2 cursor-pointer"
              >
              ...
              >
                ...
                <span>Call Us: [Clinic Phone Number]</span>
              </a>
            </div>
          </div>
          ...
          <div className="hidden lg:block lg:col-span-4 relative self-end h-[420px] w-full">
            <div className="absolute bottom-[-80px] right-0 w-[300px] h-[450px] overflow-hidden rounded-t-[32px] shadow-2xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#0f766e] via-transparent to-transparent opacity-80" />
            </div>
          </div>
        </div>
      </div>
